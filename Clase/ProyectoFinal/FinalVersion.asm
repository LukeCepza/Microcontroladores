...
; Registros para orden Sequence
	#define Seq1 0x09, A ; LED 8765 4321
	#define Seq2 0x0A, A
	#define Seq3 0x0B, A
	#define Seq4 0x0C, A
	#define Seq5 0x0D, A
...
; Registros asociados al EEPROM
	...
	#define NAME1_HS_1 0x16, A ; EEPROM 0x01
	#define NAME1_HS_2 0x17, A ; EEPROM 0x02
	#define NAME1_HS_3 0x18, A ; EEPROM 0x03
	#define SCR1 0x1F, A       ; EEPROM 0x04
	#define SCR2 0x20, A	   ; EEPROM 0x05
	#define SCR3 0x21, A	   ; EEPROM 0x06
	#define LIMA 0x22, A
 	#define LIMZ 0x23, A
...
InputSeqs call ClearKey
	  ...
	  return ;PEEEEEEEENDIENDTE QUITAR ALV ojo mucho ojo
	  btfsc CD_FLAG
	  return 
...
EEPROM_SCORES:
	...
	call MOV_EEADR
	bsf EECON1, 0, A
	movff EEDATA, 0x21 ; movemos el segundo puntaje mas reciente a la posicion tercer mas reciente

	movlw 0x06 
	call MOV_EEADR
	movf SCR3  
	call MOV_EEDATA
	call WRITE_EEPROM ; movemos del segundo mas reciente a tercer
	
	movlw 0x04 
	call MOV_EEADR
	bsf EECON1, 0, A
	movff EEDATA, 0x20 ; movemos el puntaje mas reciente a la posicion del segundo mas reciente

	movlw 0x05 
	call MOV_EEADR
	movf SCR2  
	call MOV_EEDATA
	call WRITE_EEPROM ; movemos de mas reciente a segundo

	movlw 0x04; movemos el Puntaje mas reciente
	call MOV_EEADR
	movf SCR1  
	call MOV_EEDATA
	call WRITE_EEPROM
