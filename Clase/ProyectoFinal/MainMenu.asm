...
keypad_in
RA0	MOVLW   b'11111110' ;RA0 COLUMNA RB3,RB4,RB5 Valores 0,1,2,3,4
	MOVWF   LATB
	BTFSS   PORTB,3
	GOTO    D1
	BTFSS   PORTB,4
...
RA1	MOVLW   b'11111101' ;RA1 COLUMNA RB3,RB4,RB5 Valores 0,1,2,3,4
	MOVWF   LATB
	BTFSS   PORTB,3
	GOTO    D2
	BTFSS   PORTB,4
...
RA2	MOVLW   b'11111011' ;RA2 COLUMNA RB3,RB4,RB5 Valores 0,1,2,3,4
	MOVWF   LATB
	BTFSS   PORTB,3
	GOTO    D3
	BTFSS   PORTB,4
